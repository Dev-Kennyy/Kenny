...
function Sect7() {
  return (
    <div className="align-center fixed bottom-0 left-0 z-50 flex w-full flex-col items-center justify-between gap-5 bg-white p-2 shadow shadow-orange-50 sm:flex-row">
